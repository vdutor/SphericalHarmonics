...
class FundamentalSystemCache:
    ...
    def regenerate_and_save_cache(self, max_degrees: int) -> None:
        ...
        for degree in range(max_degrees):
            ...
            d_system = self.calculate(self.dimension, degree, gtol=1e-8, num_restarts=10)
    ...
    def calculate(
        ...
        return build_fundamental_system(dimension, degree, gtol=gtol, num_restarts=num_restarts)


def build_fundamental_system(dimension, degree, *, gtol=1e-5, num_restarts=1, debug=False):
    """
...
if __name__ == "__main__":
    ...
    def regenerate_cache(dimension: int):
        ...
        FundamentalSystemCache(dimension, only_use_cache=False).regenerate_and_save_cache(
            max_degrees
        )
